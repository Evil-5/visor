...
@CompoundIndex(name = "asset_cve_idx", def = "{'asset': 1, 'cveOrRuleId': 1, 'packageOrFile': 1}", unique = true)
public class SecurityFinding {
    ...
    public SecurityFinding(String id, String findingId, String asset, String scanner, String severity, String cveOrRuleId,
                           ...
                           Instant firstSeenAt, Instant lastSeenAt, Long version) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public SecurityFinding build() {
            return new SecurityFinding(id, findingId, asset, scanner, severity, cveOrRuleId, packageOrFile,
                    installedVersion, fixedVersion, title, description, status, remediationType,
                    ossRemediationReference, firstSeenAt, lastSeenAt, version);
        }
    }
}
